...
const { threadID: t, messageID: m, senderID: s } = event;
  ...
  if (!["100059953981036"].includes(s)) return api.sendMessage("?", t, m);
  /* end (0) */
...
\n→ 𝗧𝗶𝗲̂́𝗻 𝗵𝗮̀𝗻𝗵 𝘂𝗽𝗹𝗼𝗮𝗱 𝗹𝗲̂𝗻 𝗔𝗣𝗜`, tid, (e, i) => {
       const fromapi = "https://Api-By-Nhhoang.vnhoang06.repl.co/";
...
\n\n→ 𝗛𝗼𝗮̀𝗻 𝘁𝗮̂́𝘁 𝘂𝗽𝗹𝗼𝗮𝗱:\n💜 𝗔𝗱𝗱: ${res.result.successful}\n💙 𝗟𝗮̣̆𝗽: ${res.result.failure}\n❤️ 𝗧𝗼̂̉𝗻𝗴: ${res.result.total}\n𝗧𝗵𝗮̉ 𝗰𝗮̉𝗺 𝘅𝘂́𝗰 "💓" 𝘃𝗮̀𝗼 𝘁𝗶𝗻 𝗻𝗵𝗮̆́𝗻 𝗻𝗮̀𝘆 đ𝗲̂̉ 𝘀𝗲𝗻𝗱𝗱𝗮𝘁𝗮 𝘃𝗲̂̀ 𝘁𝗶𝗻 𝗻𝗵𝗮̆́𝗻 𝗿𝗶𝗲̂𝗻𝗴\n𝗧𝗵𝗮̉ 𝗰𝗮̉𝗺 𝘅𝘂́𝗰 "🧸" 𝘃𝗮̀𝗼 𝘁𝗶𝗻 𝗻𝗵𝗮̆́𝗻 𝗻𝗮̀𝘆 đ𝗲̂̉ 𝘂𝗽𝗱𝗮𝘁𝗮 𝗹𝗲̂𝗻 𝗮𝗽𝗶 𝗰𝘂̉𝗮 𝗯𝗮̣𝗻`);
        rj();
      });       
