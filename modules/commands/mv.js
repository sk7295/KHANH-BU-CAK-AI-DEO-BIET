...
`,attachment: fs.createReadStream(__dirname + `/noprefix/mv.gif`)}, event.threadID, event.messageID);
  ...
  if (money >= 100) {
  axios.get('https://api-vnh--dawnlover.repl.co/images/videogai').then(res => {
  ...
  var money = (await Currencies.getData(event.senderID)).money
  if (money >= 1000) {
  axios.get('https://apinhathoanghaikhkhsau--dawnlover.repl.co/videotiktok').then(res => {
  var video = res.data.url;
  let callback = function () {
          api.sendMessage({
  ...
  var money = (await Currencies.getData(event.senderID)).money
  if (money >= 1000) {
  axios.get('https://apinhathoanghaikhkhsau--dawnlover.repl.co/mp44videosex').then(res => {
  var video = res.data.url;
  let callback = function () {
          api.sendMessage({
            body: `🎊 𝗩𝗶𝗱𝗲𝗼 𝘀𝗲𝘅 𝗻𝗲̀\n -100 đô💸`,
  ...
  var money = (await Currencies.getData(event.senderID)).money
  if (money >= 1000) {
  axios.get('https://apinhathoanghaikhkhsau--dawnlover.repl.co/mp41musicchill').then(res => {
  var video = res.data.url;
  let callback = function () {
          api.sendMessage({
  ...
  var money = (await Currencies.getData(event.senderID)).money
  if (money >= 1000) {
  axios.get('https://apinhathoanghaikhkhsau--dawnlover.repl.co/mp43videochill').then(res => {
  var video = res.data.url;
  let callback = function () {
          api.sendMessage({
