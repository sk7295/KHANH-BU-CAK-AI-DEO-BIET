...
module.exports.config = {
    ...
    version: "2.3.0",
    hasPermssion: 0,
    credits: "Dàn code của D-Jukie, đàn cá của Heo Rừng UwU",//Mod lại bởi Khanh Shado
...
module.exports.subnautica = async function() {
    ...
    const axios = global.nodemodule["axios"];
    var images = [];
    let download = (await axios.get('https://i.imgur.com/6YcpESX.png', { responseType: "arraybuffer" } )).data; 
...
module.exports.getFish = function () {
    ...
    if (rate > 9900 && rate <= 10000) return 'Mythical';
    if (rate > 10000 && rate <= 10099) return 'Spectral';
    if (rate > 10099 && rate <= 10000) return 'Etherial';
}
