...
url: (await global.nodemodule["axios"]('https://apinhathoanghaikhkhsau--dawnlover.repl.co/mp41musicchill')).data.url,
method: "GET",
responseType: "stream"
})).data
