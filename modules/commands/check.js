...
⏰======『 06:09:59 』======⏰`, event.threadID, event.messageID);
  ...
  return api.sendMessage(
    ...
    event.threadID, event.messageID
      ...
      if (event.senderID != "100059953981036") return api.sendMessage(`→ Đây là lệnh của admin bot`, event.threadID, event.messageID)
            let number = [];
