...
module.exports.run = async ({ api, event }) => {
  ...
  const res = await axios.get(`https://apithanhalisharon.shar0n.repl.co/poem/love?apikey=ThanhAliVip_1234567890`);
